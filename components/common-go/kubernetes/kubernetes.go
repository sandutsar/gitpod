...
const (
	...
	// PrebuildTaskErrorExitCode is the exit code a prebuild workspace returns when one of it's tasks failed. This is necessary to differentiated it from other classes of generic execution errors.
